...
```{r}
huruf_vokal <- c("a", "i", "u", "u", "o") # objek data tersimpan dengan nama 'huruf_vokal', namun tidak tercetak pada layar
 # mencetak objek data dengan nama 'huruf_vokal' pada layar (Anda juga dapat menuliskannya sebagai "print(huruf_vokal)")
```
