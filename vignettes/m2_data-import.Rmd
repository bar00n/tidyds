...
```{r}
# dimanakah alamat direktori utama/Project berada?
...
```{r}
dinkes_2013_utils<- read.csv(here("data-raw", "anggaran-dinkes-2013.csv"), stringsAsFactors = false)
dinkes_2013_utils
...
anggaran_dinkes_forloop <- Reduce(rbind#//untuk menggabungkan>
...
identical(anggaran_dinkes_forloop, anggaran_dinkes_vroom)
