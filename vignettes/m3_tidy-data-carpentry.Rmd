...
`table1` termasuk "Tidy data" karena informasi jelas dan mempunyai value 

```{r}
table2
```

`table2` tidak termasuk "Tidy data" karena ...Count & Type tidak jelas data apa harusnya case & population menjadi variable

```{r}
table3
```

`table3` tidak termasuk "Tidy data" karena ... dalam rate tidak jelas nilai apa, dan tidak boleh ada penggabungan data dalam 1 kolom
...
`table4a` tidak termasuk "Tidy data" karena ... 1999 dan 2000 tidak jelas menjelaskan tentang data apa

```{r}
table4b
```

`table4b` tidak termasuk "Tidy data" karena ...1999 dan 2000 tidak jelas menjelaskan tentang data apa

```{r}
table5
```

`table5` termasuk/tidak termasuk "Tidy data" karena ... century dan year dipisiah dan pada rate ada 2 nilai
...
```{r}
table4a_tidy <- gather(table4a, key = "year", value = "cases", 2:3, convert = TRUE)
table4a_tidy
```
